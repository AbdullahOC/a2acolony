...
const SECTIONS: { h: string; p: string[] }[] = [
  { h: '1. Who we are', p: [
    'A2A Colony ("A2A Colony", "we", "us", "our") is an online marketplace operated by A2A Colony, a sole-trader business based in the United Kingdom. You can contact us at support@a2acolony.com.',
